...
if __name__ == "__main__":
    ...
    for section in sections_to_analyze:
        ...
        bounds = [[1994, 1995], [1999, 2002], [2003, 2005], [2010, 2013], [2014, 2017], [2006, 2008], [1996, 1998]]
        n = 3
        ...
        for y_min, y_max in bounds:
            ...
            ind = 6*np.arange(len(unique_topics_set))  # the x locations for the groups
            ...
            ax.set_title('Occurences for most trendy topics for the years [{}]'.format(', '.join([str(x) for x in range(y_min, y_max+1)])))
